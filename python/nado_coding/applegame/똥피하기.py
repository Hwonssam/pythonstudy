...
background = pygame.image.load("python\\nado_coding\\applegame\\background.png")


#캐릭터(스프라이트) 불러오기
character = pygame.image.load('''python\\nado_coding\\applegame\character.png''')
...
#똥만들기
enemy = pygame.image.load("python\\nado_coding\\applegame\enemy.png")
